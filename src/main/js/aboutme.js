      ...
      <div className="aboutme-grid">
        ...
        <div className="aboutme-item">
          ...
          <div>
            ...
            <div className="value">98.12.31</div>
          </div>
        </div>
        ...
        <div className="aboutme-item">
          ...
          <div>
            ...
            <div className="value">경기도 남양주시 다산동</div>
          </div>
        </div>
        ...
        <div className="aboutme-item">
          ...
          <div>
            ...
            <div className="value">010-2236-6908</div>
          </div>
        </div>
        ...
        <div className="aboutme-item">
          ...
          <div>
            ...
            <div className="value">pickjog@gmail.com</div>
          </div>
        </div>
        ...
        <div className="aboutme-item">
          ...
          <div>
            ...
            <div className="value">백석고등학교</div>
