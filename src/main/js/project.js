      ...
      <div className="project-content">
        <div className="project-card">
          <div className="project-card-img">
            <img
              src={`${process.env.PUBLIC_URL}/img/project/project1.png`}
              alt="project1"
            />
          </div>
          <div className="project-card-desc">
            ...
            <p>
              KREAM 웹 사이트 클론 프로젝트를 진행하였습니다.(React)
              <br />
            </p>
            <p>크림 웹 사이트 : </p>
            <a className="address" href="https://kream.co.kr/">
              https://kream.co.kr/
            </a>
            <br />
            <p>깃허브 소스 코드 : </p>
            ...
            <a
              className="address"
              href="https://github.com/dlxodud123/fream_front"
            >
            ...
            <a
              className="address"
              href="https://github.com/junhyeong9812/fream_back"
            >
        ...
        <div className="project-card">
          <div className="project-card-img">
            <img
              src={`${process.env.PUBLIC_URL}/img/project/project2.png`}
              alt="project1"
            />
          </div>
          <div className="project-card-desc">
            ...
            <a
              className="address"
              href="https://github.com/junhyeong9812/ERP-Project.git"
            >
              https://github.com/junhyeong9812/ERP-Project.git
            </a>
          </div>
        </div>
        <div className="project-card">
          <div className="project-card-img">
            <img
              src={`${process.env.PUBLIC_URL}/img/project/project3.png`}
              alt="project1"
            />
          </div>
          <div className="project-card-desc">
            ...
            <a
              className="address"
              href="https://github.com/KimJaeHwan98/portfolio"
            >
              https://github.com/KimJaeHwan98/portfolio
            </a>
          </div>
        </div>
      </div>
